...
export function SiteHeader() {
  ...
  React.useEffect(() => {
    // Check initial preference or stored class
  ...
  return (
    <>
      ...
      <div className="w-full bg-secondary-container text-on-secondary-container px-4 py-2 text-xs font-medium flex items-center justify-center gap-2 border-b border-outline-variant/40">
        ...
        <span>
          Material 3 Design for Web is currently in active development. Components are live in preview.
        </span>
      </div>
      ...
      <header className="sticky top-0 z-50 w-full bg-surface/90 backdrop-blur-md border-b border-outline-variant/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-2 text-on-surface hover:opacity-90 transition-opacity">
              ...
              <span className="font-semibold text-lg tracking-tight">
                Material 3 <span className="text-primary font-normal">Design</span>
              </span>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link href="/components/button">
              <Button
                variant={pathname.startsWith("/components/button") ? "tonal" : "text"}
                size="sm"
                className="text-sm font-medium"
              >
                Button Docs
